...
export default function MachineManagement() {
  ...
  // Fallback to mock data if Firestore is loading or empty
    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-2 duration-500 pb-10">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs md:text-sm text-muted-foreground">Register and manage equipment inventory ({machines.length} units).</p>
        </div>
        <div className="flex gap-2 w-full sm:w-auto">
          {firestoreMachines.length === 0 && (
          ...
          <Table className="min-w-[900px]">
            <TableHeader className="bg-white/5">
              <TableRow className="border-white/5 hover:bg-transparent">
                ...
                <TableHead className="text-right text-[10px] uppercase font-bold tracking-widest pr-6">Operations</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
